package com.example.onlinevotingsystem.adapter;
...
import com.example.onlinevotingsystem.activities.VotingActivity;
import com.example.onlinevotingsystem.model.canditate;
...
public class CandidateResultAdapter extends RecyclerView.Adapter<CandidateResultAdapter.ViewHolder> {
    ...
    private List<canditate> list;
    private FirebaseFirestore firebaseFirestore;

    public CandidateResultAdapter(Context context, List<canditate> list) {
                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot documentSnapshots, @Nullable FirebaseFirestoreException error) {
                        ...
                        if (!documentSnapshots.isEmpty()) {
                            ...
                            canditate canditate = list.get(position);
                            canditate.setCount(count);
                            list.set(position, canditate);
